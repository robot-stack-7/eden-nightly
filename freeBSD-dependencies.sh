...
pkg install autoconf bash boost-libs catch2 cmake ccache enet ffmpeg fusefs-libs \
            ...
            ninja nlohmann-json openssl opus pkgconf qt6-base qt6ct qt6-multimedia qt6-5compat \
            qt6-tools qt6-translations qt6-wayland sdl2 sdl3 unzip vulkan-tools vulkan-headers vulkan-loader wget zip zstd
